...
__device__ const unsigned char cuda_s_box[16][16]=
...
__device__ const unsigned char cuda_inv_s_box[16][16]=
...
__device__ unsigned char cuda_indexSbox(unsigned char string);
__device__ unsigned char cuda_indexInvSbox(unsigned char string);
__device__ void cuda_subBytes(unsigned char * &string, int rows, int cols);
__device__ void cuda_invSubBytes(unsigned char * &string, int rows, int cols);
__device__ void cuda_initArr(unsigned char ** &strArr, int rows, int cols);
__device__ void cuda_killArr(unsigned char ** strArr, int rows, int cols);
...
__global__ void encryptDecryptNBlocksCuda(int start, int blocks, bool encrypt, unsigned char * dev_expandedKeys, unsigned char * dev_data, int aesBlockSize, unsigned char*key, int keySize, int numRounds);