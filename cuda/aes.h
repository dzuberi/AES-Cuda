...
unsigned char indexSbox(unsigned char string);
unsigned char indexInvSbox(unsigned char string);
void subBytes(unsigned char * &string, int rows, int cols);
void invSubBytes(unsigned char * &string, int rows, int cols);
void initArr(unsigned char ** &strArr, int rows, int cols);
void killArr(unsigned char ** strArr, int rows, int cols);
void printArr(unsigned char ** strArr, int rows, int cols);
